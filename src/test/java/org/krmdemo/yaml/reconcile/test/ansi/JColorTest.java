...
public class JColorTest {
    ...
    @Test
    public void testShouldLookGood() {
        ...
        */
        ...
        String str_1 = colorize("This text will be yellow on magenta", YELLOW_TEXT(), MAGENTA_BACK());
        System.out.println(StringEscapeUtils.escapeJava(str_1));
        ...
        String str_2 = colorize("This text will be red on yellow", myFormat);
        System.out.println(StringEscapeUtils.escapeJava(str_2));
