...
escSeqAttrCode : ESC_SEQ_RESET_ALL | ESC_SEQ_RESET_FG_COLOR | ESC_SEQ_RESET_BG_COLOR
        ...
        | ESC_SEQ_APPLY_FG_BRIGHT_BLACK | ESC_SEQ_APPLY_FG_BRIGHT_RED
        | ESC_SEQ_APPLY_FG_BRIGHT_GREEN | ESC_SEQ_APPLY_FG_BRIGHT_YELLOW
        | ESC_SEQ_APPLY_FG_BRIGHT_BLUE  | ESC_SEQ_APPLY_FG_BRIGHT_MAGENTA
        | ESC_SEQ_APPLY_FG_BRIGHT_CYAN  | ESC_SEQ_APPLY_FG_BRIGHT_WHITE

        | ESC_SEQ_APPLY_BG_BRIGHT_BLACK | ESC_SEQ_APPLY_BG_BRIGHT_RED
        | ESC_SEQ_APPLY_BG_BRIGHT_GREEN | ESC_SEQ_APPLY_BG_BRIGHT_YELLOW
        | ESC_SEQ_APPLY_BG_BRIGHT_BLUE  | ESC_SEQ_APPLY_BG_BRIGHT_MAGENTA
        | ESC_SEQ_APPLY_BG_BRIGHT_CYAN  | ESC_SEQ_APPLY_BG_BRIGHT_WHITE
        ;
